...
import com.example.e_shop.activities.ShowAllActivity;
import com.example.e_shop.adapter.CategoryAdapter;
import com.example.e_shop.adapter.NewProductsAdapter;
import com.example.e_shop.adapter.PopularProductAdapter;
import com.example.e_shop.models.CategoryModel;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressDialog.setTitle("Wecome To My E_shop App");
        ...
        Log.i("MainTrad",Thread.currentThread().getName());
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                Log.i("DiffTrad",Thread.currentThread().getName());
            }
        };
